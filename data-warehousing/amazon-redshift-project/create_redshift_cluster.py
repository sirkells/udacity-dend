...
def get_redshift_cluster_props(redshift, DWH_CLUSTER_IDENTIFIER):
    '''
    Gets Redshift clusters properties
    '''
...
def main():
    ...
    redshiftProps = get_redshift_cluster_props(redshift, DWH_CLUSTER_IDENTIFIER)
    
    DWH_ENDPOINT = redshiftProps['Endpoint']['Address']
    DWH_ROLE_ARN = redshiftProps['IamRoles'][0]['IamRoleArn']
