...
def data_quality_check(df, metric: dict):
    """
...
def main():
    ...
    # airport  table
    print("Processing airport Table")
    try:
    ...
    print("Processing Passenger Table")
    try:
    ...
    try:
        airport_table_check = data_quality_check(spark, airport_table,
                                                 metrics(["airport_id", "airport_name"], ["string", "string"]))
    except Exception as e:
    ...
    try:
        country_table_check = data_quality_check(spark, country_table,
                                                 gen(["country_id", "country_name"], ["int", "string"]))
    except Exception as e:
    ...
    try:
        passenger_table_check = data_quality_check(spark, passenger_table,
                                                   metrics(["passenger_id", "flight_no"], ["int", "string"]))
    except Exception as e:
    ...
    # Time check
    try:
        time_table_check = data_quality_check(spark, time_table, metrics(["time_id", "hour"], ["timestamp", "int"]))
    except Exception as e:
    ...
    # Entry check
    try:
        entry_table_check = data_quality_check(spark, entry_table, metrics(["time_id", "entry_id"], ["timestamp", "int"]))
    except Exception as e:
